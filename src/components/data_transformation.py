#feature engineering, data cleaning, convert category to numerical
import sys
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            numerical_features=['AT','AP','AH','AFDP','GTEP','TIT','TAT','CDP']
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            target_column_name=['TEY','CO','NOX']
            numerical_columns=['AT','AP','AH','AFDP','GTEP','TIT','TAT','CDP']
